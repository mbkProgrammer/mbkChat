...
const ChatItem = ({ data }) =>
  ...
  (
    <div className=" py-3 px-4 w-full h-fit flex items-center duration-100 hover:bg-blue-100 active:bg-green-200 select-none">
      <div className="p-0 m-0 relative">
        <span className="absolute w-3 h-3 bg-green-600 rounded-full z-10 right-0 bottom-1.5" />
        <Image src="/assets/img/user.png" className="rounded-full" width="48" height="48" alt="user picture" />
      </div>
